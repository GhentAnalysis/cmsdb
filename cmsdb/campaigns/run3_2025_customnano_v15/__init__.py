...
"""
Common, analysis independent definition of the 2025 customNanoAOD data-taking campaign
...
This campaign contains data only (PromptReco), no corresponding MC samples.
...
campaign_run3_2025_customnano_v15 = Campaign(
    name="run3_2025_customnano_v15",
    id=320251201,  # 3 2025 12 01(u)
    ecm=13.6,
    bx=25,
    aux={
        "tier": "CustomNanoAOD",
...
import cmsdb.campaigns.run3_2025_customnano_v15.data  # noqa
